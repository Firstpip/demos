  ...
  return (
    <>
      <Hero
        ...
        description="30개 조합사가 함께 빚어낸 봄의 거실. 컬렉션 페이지에서 8축 필터로 즉시 좁히거나, 브랜드 단위로 천천히 결을 비교하세요."
        ctas={[
      ...
      <section aria-label="이번 시즌 컬렉션" className="mx-auto max-w-[1280px] px-4 py-16">
        <header className="mb-6 flex flex-wrap items-end justify-between gap-2">
          <div>
            ...
            <p className="mt-1 text-sm text-text-muted">컬렉션 페이지 안에서 8축 필터로 즉시 좁힐 수 있습니다.</p>
          </div>
